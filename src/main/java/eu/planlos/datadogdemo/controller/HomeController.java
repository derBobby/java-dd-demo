...
import eu.planlos.datadogdemo.model.Form;
import eu.planlos.datadogdemo.repository.EmployeeRepository;
import eu.planlos.datadogdemo.service.EmployeeMetricsService;
...
public class HomeController {
    ...
    @Autowired
    public HomeController(EmployeeMetricsService employeeMetricsService, EmployeeRepository employeeRepository, MeterRegistry meterRegistry) {
    ...
    public String updateEmployee(@PathVariable("id") long id, @ModelAttribute Form form, Model model) {
        //Retrieve and merge logic to the service. That's a business operation
        Employee employee = employeeRepository.findById(id)
                .orElseThrow(() -> new IllegalArgumentException("Invalid employee Id:" + id));
